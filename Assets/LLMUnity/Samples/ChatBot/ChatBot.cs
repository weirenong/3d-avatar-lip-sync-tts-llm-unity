...
namespace LLMUnitySamples
{
    public class ChatBot : MonoBehaviour
    {
        ...
        //cross platform tts
        public CrossPlatformTTS crossPlatformTTS;
        ...
        void OnInputFieldSubmit(string newText)
        {
            ...
            Task chatTask = llmAgent.Chat(message, aiBubble.SetText, () =>
            {
                AllowInput();

                if (crossPlatformTTS != null)
                {
                    string aiResponse = aiBubble.GetText();
                    crossPlatformTTS.Speak(aiResponse);
                }
            });
            inputBubble.SetText("");
        }
